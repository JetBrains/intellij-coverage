...
package testData.custom.IDEA_57695

import testData.custom.IDEA_57695.GeneratorClassLoader.foo
...
private object GeneratorClassLoader : ClassLoader() {
    val BASE_NAME: String = GeneratorClassLoader::class.java.`package`.name
