...
public class UnloadedUtil {
  ...
  @SuppressWarnings("unused") // used in IntelliJ
  public static void appendUnloadedClass(ProjectData projectData, String className, byte[] classBytes, boolean branchCoverage) {
    InstrumentationOptions options = createOptionsFromProject(projectData, branchCoverage);
    appendUnloadedClass(projectData, className, new ClassReader(classBytes), new ProjectContext(options), true);
  }
