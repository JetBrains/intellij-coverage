...
public abstract class AbstractBranchesInstrumenter extends Instrumenter {
  protected final BranchDataContainer myBranchData = new BranchDataContainer(this);

  public AbstractBranchesInstrumenter(final ProjectData projectData, ClassVisitor classVisitor, String className, boolean shouldCalculateSource) {
  ...
  protected MethodVisitor createMethodLineEnumerator(MethodVisitor mv, String name, String desc, int access, String signature,
    ...
    if (myProjectData.isInstructionsCoverageEnabled()) {
      ...
      enumerator = new BranchesEnumerator(this, myBranchData, mv, access, name, desc, signature, exceptions);
    }
    return chainFilters(name, desc, access, signature, exceptions, enumerator);
  }

  public abstract MethodVisitor createTouchCounter(MethodVisitor methodVisitor, BranchDataContainer branchData, BranchesEnumerator enumerator, int access, String name, String desc, String className);
